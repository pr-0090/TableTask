...
public class GroundController {
    ...
    public List<Ground> getData() {
        return GlobalApiResponse.<List<Ground>>builder().data(this.groundService.getAll()).statusCode(200).message("data retreived successfully").build();
    }

    @PostMapping
    public void save(@RequestBody @Valid GroundPojo groundPojo) {
